...
- **🚀 Live Demo**: [rise-why-young.vercel.app](https://rise-why-young.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/rise-why-young)
...
1. `git clone https://github.com/blefnk/rise-why-young.git`
2. `cd rise-why-young`
3. `bun i`
